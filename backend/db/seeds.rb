...
User.create(email: 'm@m.com', password: '12345678')
...
Research.create(topic: 'Solar Panels', description: 'Research into making solar panels more efficient. Blahb lah blah blah blah blah', files: '[]', user_id: 1)
